...
@Setter
@AllArgsConstructor
public class ClientboundAwardStatsPacket extends Packet {
    private final @NonNull Object2IntMap<Statistic> statistics = new Object2IntOpenHashMap<>();

    public ClientboundAwardStatsPacket(ByteBuf data) {
        super(data);
    }

    public ClientboundAwardStatsPacket(Packet packet) {
