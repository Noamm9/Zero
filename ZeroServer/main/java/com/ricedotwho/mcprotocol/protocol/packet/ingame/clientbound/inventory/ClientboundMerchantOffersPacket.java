...
@Setter
@AllArgsConstructor
public class ClientboundMerchantOffersPacket extends Packet {
    private int containerId;
    private @NonNull List<VillagerTrade> offers;
    private int villagerLevel;
    private int villagerXp;
    private boolean showProgress;
    private boolean canRestock;

    public ClientboundMerchantOffersPacket(ByteBuf data) {
        super(data);
    }

    public ClientboundMerchantOffersPacket(Packet packet) {
