...
@Setter
@AllArgsConstructor
public class ServerboundChatCommandSignedPacket extends Packet {
    ...
    public ServerboundChatCommandSignedPacket(ByteBuf data) {
        super(data);
    }

    public ServerboundChatCommandSignedPacket(Packet packet) {
