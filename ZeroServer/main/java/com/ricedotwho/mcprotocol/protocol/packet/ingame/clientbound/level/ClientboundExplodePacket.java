...
@Setter
@AllArgsConstructor
public class ClientboundExplodePacket extends Packet {
    private Vector3d center;
    private float radius;
    private int blockCount;
    private @Nullable Vector3d playerKnockback;
    private @NonNull Particle explosionParticle;
    private @NonNull Sound explosionSound;
    private @NonNull WeightedList<BlockParticleInfo> blockParticles;

    public ClientboundExplodePacket(ByteBuf data) {
        super(data);
    }

    public ClientboundExplodePacket(Packet packet) {
