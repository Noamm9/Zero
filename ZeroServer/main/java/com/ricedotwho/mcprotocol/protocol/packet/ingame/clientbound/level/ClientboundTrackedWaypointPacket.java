...
import org.geysermc.mcprotocollib.protocol.data.game.level.waypoint.*;
...
@Setter
@AllArgsConstructor
public class ClientboundTrackedWaypointPacket extends Packet {
    private WaypointOperation operation;
    private TrackedWaypoint waypoint;

    public ClientboundTrackedWaypointPacket(ByteBuf data) {
        super(data);
    }

    public ClientboundTrackedWaypointPacket(Packet packet) {
