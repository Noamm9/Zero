...
@Setter
@AllArgsConstructor
public class ClientboundPlayerInfoUpdatePacket extends Packet {
    private EnumSet<PlayerListEntryAction> actions;
    private PlayerListEntry[] entries;

    public ClientboundPlayerInfoUpdatePacket(ByteBuf data) {
        super(data);
    }

    public ClientboundPlayerInfoUpdatePacket(Packet packet) {
