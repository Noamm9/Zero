...
@Setter
@AllArgsConstructor
public class ServerboundSetCommandBlockPacket extends Packet {
    ...
    public ServerboundSetCommandBlockPacket(ByteBuf data) {
        super(data);
    }

    public ServerboundSetCommandBlockPacket(Packet packet) {
