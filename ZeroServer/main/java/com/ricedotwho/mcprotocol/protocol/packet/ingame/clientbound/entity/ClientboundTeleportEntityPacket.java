...
@Setter
@AllArgsConstructor
public class ClientboundTeleportEntityPacket extends Packet {
    ...
    public ClientboundTeleportEntityPacket(ByteBuf data) {
        super(data);
    }

    public ClientboundTeleportEntityPacket(Packet packet) {
